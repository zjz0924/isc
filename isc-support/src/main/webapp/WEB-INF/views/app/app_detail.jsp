				...
				<dl class="permission-list">
					...
					<dd>
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-9">
								<select class="select input-text" id="isEffective" name="isEffective">
									<option value="1" <c:if test="${facadeBean.isEffective == 1}">selected="selected"</c:if>>是</option>
									<option value="0" <c:if test="${facadeBean.isEffective == 0}">selected="selected"</c:if>>否</option>
								</select>
							</div>
						</div>
