	...
	<form id="queryForm" name="queryForm" action="${ctx}/statistic/income" method="post">
		<div class="page-container">
			<div class="text-c" style="text-align: left"> 
				    生效时间：
				<input type="text" onfocus="WdatePicker()" id="startEffectiveDate" name="startEffectiveDate" class="input-text Wdate" style="width:110px;" value="${startEffectiveDate}">
				-
				<input type="text" onfocus="WdatePicker()" id="endEffectiveDate" name="endEffectiveDate" class="input-text Wdate" style="width:110px;" value="${endEffectiveDate}">&nbsp;&nbsp;&nbsp;&nbsp;
				
				过期时间：
				<input type="text" onfocus="WdatePicker()" id="startExpireDate" name="startExpireDate" class="input-text Wdate" style="width:110px;" value="${startExpireDate}">
				-
				<input type="text" onfocus="WdatePicker()" id="endExpireDate" name="endExpireDate" class="input-text Wdate" style="width:110px;" value="${endExpireDate}">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="text-c" style="text-align: left;margin-top:10px;"> 
				类型：<select class="select input-text" id="type" name="type" style="width: 237px;margin-left: 30px;margin-right: 8px;">
				...
				支付方式：<select class="select input-text" id="payType" name="payType" style="width: 237px;margin-left: 3px;">
					<option value="">全部</option>
